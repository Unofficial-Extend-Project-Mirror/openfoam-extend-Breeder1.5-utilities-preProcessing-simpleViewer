...
// Create point
FXGLText::FXGLText():pos(0.0f,0.0f,0.0f){
  }

// Copy constructor
FXGLText::FXGLText(const FXGLText& orig):FXGLObject(orig),pos(orig.pos){
  }

// Create initialized point
FXGLText::FXGLText(FXfloat x,FXfloat y,FXfloat z):pos(x,y,z){
  }
